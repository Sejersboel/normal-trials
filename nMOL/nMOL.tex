...
\subsection*{Adds}
\begin{itemize}
\item \textbf{Sun-Eater} mage med 3 flag, 1. prioritet. De laver et grimt
  \emph{negate}-AOE på en tilfældig, der skader meget.
\item \textbf{Dreadstalker} Bueskytte med 2 flag. 2. prioritet. Laver 3 kegler
  ...
  stedet Dreadstalker.
\item \textbf{Shadowguard} 1h and shield/Sword\&Board med 1 flag, 3.
  prioritet(2. prioritet på vet). Laver bleed effect.
\item \textbf{Savage} 2h uden flag. Sidste prioritet. Laver \emph{Armor
...
trykbølge ud fra Zhaj'hassa, som slår ihjel. \\
...
Den anden tank hiver katte ind.
...
\begin{itemize}
	\item \textbf{Shaman} Healer sig selv og andre ogres. Dette heal skader
		...
		Sun-Eaters.
	\item \textbf{Flesh-Render} Skal interruptes hele tiden. Alle må gerne
...
hive adds \textbf{Rage of S'kinrai} ind. Fjender med Lunar Aspect lave
